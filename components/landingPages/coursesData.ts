...
const coursesData: Courses = {
  tradingAcademy: {
    ...
    isProCourse: false,
    shortDescription:
      'If you have no or little experience with trading start here. This course covers the basics such as indicators, risk management, types of orders, etc. This resource will build a strong foundation for your trading career.',
    longDescription:
  ...
  algorithmicTradingAcademy: {
    ...
    isProCourse: true,
    shortDescription:
      'If you are new to alogrithmic trading then this is the course for you. This covers algorithmic trading techniques that can be applied to a variety of markets and platforms.',
    longDescription:
      'If you are new to algorithmic trading this is the course for you. This covers all the necessary knowledge and skills to create your own trading algorithms. This resource focuses purely on algorithmic trading concepts. Topics such as proper risk management, cleaning data, backtesting, algorithmic strategies, etc will be discussed in-depth with many examples. It does not spend significant time on any specific trading platform. Once you have mastered the techniques in this course you will be well prepared for our more advanced courses.',
  ...
  futuresWithQuantconnect: {
    ...
    isProCourse: true,
    shortDescription:
      'If you already have a decent grasp on the basics of trading then this course will be a good option for you. It focuses specifically on using QuantConnect, a premier algorithmic trading platform, with Futures.',
    longDescription:
      // eslint-disable-next-line quotes
      "Discover how to use Python to develop production-grade trading algorithms. Many hedge-funds and proprietary trading firms use QuantConnect's LEAN engine to manage their portfolios and data feeds. This is one of our more advanced courses. As a result, it is recommended that you either have prior experience with algorithmic trading and programming. If you are just getting started our Trading Academy, Algorithmic Trading Academy, TradingView, and MT4 courses are all more appropriate starting points. QuantConnect has developed a version of Python designed specifically for algorithmic trading. It has many added functions and featuers to make developing advanced trading algorithms easier. QuantConnect has also developed the LEAN engine. This is a portfolio management and backtesting framework that runs on the cloud. It automatically handles all data pipelines and eliminates the risk of look-forward bias. Attempting to develop QuantConnect's infrastructure on your own would take years. Programming algorithms in QuantConnect allows you to focus purely on your algorithm while QuantConnect handles everything else.",
  ...
  marketResearchWithPython: {
    ...
    isProCourse: true,
    shortDescription:
      'The majority of traders do not spend enough time analyzing market data in-depth. Python with Jupyter notebooks is the best option for analyzing data and market trends.',
    longDescription:
      // eslint-disable-next-line quotes
