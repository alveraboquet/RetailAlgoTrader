...
const About = () => {
  return (
    <div>
      <SEO
        url="https://retailalgotrader.com/about"
        openGraphType="website"
        schemaType="website"
        title="About RetailAlgoTrading"
        ...
        <article className="container fs-5">
          ...
          <section className="row d-flex align-items-center text-center">
            ...
            <div className="col-md-6">
              ...
              <p>
                Through much trial and error we were able to get a hang of
                trading and algorithms; however, we were frustrated at how much
                time and energy had been wasted.
              </p>
              <p>
                RetailAlgoTrading has been created as a comprehensive resource
                for both trading and the creation of trading algorithms.
              </p>
              <p>
          ...
          <section className="row">
            ...
            <p>
              We aim to be your go-to partner for anything related to trading.
              We plan to do this by providing quality and efficient resources
              for a variety of markets and programs.
            </p>
            <p>
              We will generate value for our clients by providing significant
              time savings and increased knowledge.
            </p>
          </section>
          <section className="row">
          ...
          <section className="row">
            ...
            <p>
              We need to know about these issues so that we can provide users
