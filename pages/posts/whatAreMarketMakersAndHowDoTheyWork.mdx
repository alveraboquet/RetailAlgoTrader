...
export default ({ children }) => (
  <LayoutPost
    url="https://www.retailalgotrader/posts/whatAreMarketMakersAndHowDoTheyWork"
    ...
    description="There is a lot of confusion and inaccurate beliefs around market
        ...
        foundational level."
    image="https://www.retailalgotrader/images/posts/whatAreMarketMakers/MarketMaker-Cover.webp?v1"
    createdAt="08-11-22"
    modifiedAt="08-11-22"
    keywords="essential facts of market makers, what are market makers, how do market makers work"
  >
    {children}
  </LayoutPost>
);
