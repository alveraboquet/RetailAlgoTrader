...
<figure>
  <Image
    src="/images/posts/howMuchMoney/growingMoney.webp"
    className="rounded"
    height={1299}
    width={2309}
    alt=""
...
1. [Don't make the common mistake](#dont-make-the-common-mistake)
2. [How much can you expect to earn?](#how-much-can-you-expect-to-earn)
3. [The three factors in income potential](#the-three-factors-in-income-potential)
4. [So how do you trade if you do not have much capital?](#so-how-do-you-trade-if-you-do-not-have-much-capital)
...
export default ({ children }) => (
  <LayoutPost
    url="https://retailalgotrader/posts/howMuchMoneyCanIMakeTrading"
    title="How much money can I make trading?"
    description="Discover how much a retail trader can realistically expect to earn."
