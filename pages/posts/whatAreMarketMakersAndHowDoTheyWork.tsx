        ...
        <article className="row fs-5 m-2" style={{ color: '#3c484e' }}>
          ...
          <div className="col-md-10 col-lg-8 p-0 p-md-5 pt-md-3 pb-md-3 rounded">
            ...
            <p>
              ...
              price is $800.95. The market maker is offering to buy TSLA shares
              at $799.52 and sell TSLA shares at $800.95.
            </p>
            <p>
            ...
            <p>
              ...
              not care. You can either buy at their quoted price or wait for
              what you believe to be a fair price.
            </p>
            <p>
              The benefit of this system (and it is a huge benefit) is that you
              know for certain that the market maker is willing to buy or sell
              at anytime. There is not the risk that you will be unable to find
              a buyer or a seller for your asset.
            </p>
            <p>
            ...
            <p>
              ...
              spread ($1.43 in this example). So they make a profit of $1.43 for
              every share of TSLA they trade. This may not seem like a lot but
              when you consider the immense volume of TSLA it adds up very
              quickly.
            </p>
            <figure className="text-center m-md-5">
              <Image
            ...
            <p>
              ...
              For an illiquid asset with low trading volume, it is possible the
              price of the security significantly drops before they can sell the
              shares to a trader.
            </p>
            <p>
