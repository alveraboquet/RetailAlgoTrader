...
<figure>
  <Image
    src="/images/courses/tradingAcademy/advancedStrategies/trade1EntryScale.webp"
    height={1502}
    width={1411}
    alt=""
  />
...
<figure>
  <Image
    src="/images/courses/tradingAcademy/advancedStrategies/trade1PositionSize.webp"
    height={2160}
    width={3840}
    alt=""
  />
...
<figure>
  <Image
    src="/images/courses/tradingAcademy/advancedStrategies/trade2EntryScale.webp"
    height={2160}
    width={3840}
    alt=""
  />
...
<figure>
  <Image
    src="/images/courses/tradingAcademy/advancedStrategies/trade2Exits.webp"
    height={2160}
    width={3840}
    alt=""
  />
...
| ---------------------- | --------------------------------------------- | ------------- |
| First 1/2 of Order #1  | 0.5 $\times$ 182 $\times$ ($161.41 - $154.96) | $586.95       |
| Second 1/2 of Order #1 | 0.5 $\times$ 182 $\times$ ($165.60 - $154.96) | $968.24       |
| First 1/2 of Order #2  | 0.5 $\times$ 337 $\times$ ($168.24 - $157.37) | $1,831.60     |
| Second 1/2 of Order #2 | 0.5 $\times$ 337 $\times$ ($171.81 - $157.37) | $2,433.14     |
...
<figure>
  <Image
    src="/images/courses/tradingAcademy/advancedStrategies/tradeNoScale.webp"
    height={2160}
    width={3840}
    alt=""
  />
...
| Order            | Formula                          | Profit        |
| ---------------- | -------------------------------- | ------------- |
| Order #1         | 370 $\times$ ($161.41 - $154.96) | $2,386.60     |
